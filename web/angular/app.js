 	...
 	menu: [
      ...
      { url: '#member_manage',
        title: 'จัดการสมาชิก', 
      	icon:'fa-newspaper-o', 
      	hidden: true, 
        view : 'views/setting/member_manage.html',
      ...
      { url: '#member_history',
        title: 'ประวัติสมาชิก', 
      	icon:'fa-newspaper-o', 
      	hidden: true, 
        view : 'views/setting/member.html',
      ...
      { url: '#agent_manage',
        title: 'จัดการ Agent', 
      	icon:'fa-users', 
      	hidden: true, 
        view : 'views/setting/agent_manage.html',
      ...
      { url: '#setting',
        title: 'Agent', 
      	icon:'fa-gear', 
      	hidden: true, 
        view : 'views/setting/setting.html',
        ctrl: 'Setting.Ctrl',
      },
      { url: '#conf',
        title: 'Conf', 
